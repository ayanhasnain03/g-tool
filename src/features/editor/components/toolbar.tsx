...
export const Toolbar = ({
  ...
  const initialFontLinethrough =
    editor?.getActiveFontLinethrough() || FONT_LINETHROUGH;
  const initialFontUnderline =
    editor?.getActiveFontUnderline() || FONT_UNDERLINE;
        ...
        <div className="flex items-center h-full justify-center">
          <Hint label="Font" side="bottom" sideOffset={5}>
            <Button
              ...
              size="sm"
              variant={activeTool === "font" ? "secondary" : "ghost"}
            >
        ...
        <div className="flex items-center h-full justify-center">
          <Hint label="Bold" side="bottom" sideOffset={5}>
            <Button
              onClick={toggleBold}
              size="icon"
              variant={properties.fontWeight > 500 ? "secondary" : "ghost"}
            >
        ...
        <div className="flex items-center h-full justify-center">
          <Hint label="Italic" side="bottom" sideOffset={5}>
            <Button
              ...
              size="icon"
              variant={
                properties.fontStyle === "italic" ? "secondary" : "ghost"
              }
            >
        ...
        <div className="flex items-center h-full justify-center">
          <Hint label="Underline" side="bottom" sideOffset={5}>
            <Button
              ...
              size="icon"
              variant={properties.fontUnderline ? "secondary" : "ghost"}
            >
        ...
        <div className="flex items-center h-full justify-center">
          <Hint label="Strike" side="bottom" sideOffset={5}>
            <Button
              ...
              size="icon"
              variant={properties.fontLinethrough ? "secondary" : "ghost"}
            >
        ...
        <div className="flex items-center h-full justify-center">
          <Hint label="Align left" side="bottom" sideOffset={5}>
            <Button
              ...
              size="icon"
              variant={properties.textAlign === "left" ? "secondary" : "ghost"}
            >
        ...
        <div className="flex items-center h-full justify-center">
          <Hint label="Align center" side="bottom" sideOffset={5}>
            <Button
              ...
              size="icon"
              variant={
                properties.textAlign === "center" ? "secondary" : "ghost"
              }
            >
